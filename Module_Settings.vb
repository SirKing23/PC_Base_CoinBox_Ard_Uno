...
Module Module_Settings
    ...
    Public Function CheckSettings() As Boolean
        Dim mySetInit As String = My.Settings.Access
    ...
    Public Function SystemSettingsSave()
        ...
        With SetUp_Page
            ...
            ' commented Out - ms word, ppt, excel and powerpoint will not be terminated by default by the terminator :)
    ...
    Public Function RatesLoad(ByVal datagrid As DataGridView)
        ...
        'My.Settings.Settings_Rates = 0
        'My.Settings.Settings_Rates_Value = 0
